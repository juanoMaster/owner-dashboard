...
.cal-dark .fc-daygrid-day { background: #111a11; }\
...
.cal-dark .fc-button { font-size: 12px; padding: 6px 14px; background: #0d1a12; border: 1px solid #2a3e28; color: #8a9e88; border-radius: 8px; font-weight: 600; }\
.cal-dark .fc-button:hover { background: #1a2a1a; color: #c8d8c0; }\
...
const filePath = path.join(__dirname, "app", "components", "DashboardClient.tsx")
fs.writeFileSync(filePath, dashboardClient, "utf8")
console.log("OK: DashboardClient.tsx escrito")