...
function ReservarInner() {
  ...
  const s: Record<string, CSSProperties> = {
    page: { fontFamily: "sans-serif", color: "#f0ede8", background: "#0a1208", minHeight: "100vh" },
    nav: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 28px", height: "54px", borderBottom: "1px solid #111e11", background: "#050d05", boxShadow: "0 1px 20px #00000050" },
    logo: { fontFamily: "Georgia,serif", fontSize: "16px", letterSpacing: "3.5px", color: "#c8b878", textTransform: "uppercase" as const },
    logoSpan: { color: "#7ab87a" },
    backBtn: { background: "transparent", border: "1px solid #1a2e1a", color: "#4a6a48", fontSize: "11px", padding: "7px 16px", borderRadius: "20px", cursor: "pointer" },
    steps: { display: "flex", background: "#050d05", borderBottom: "1px solid #111e11" },
    stepBase: { flex: 1, padding: "14px 6px", textAlign: "center" as const, fontSize: "9px", letterSpacing: "2px", textTransform: "uppercase" as const, color: "#1a2e1a", borderBottom: "2px solid transparent" },
    stepActive: { flex: 1, padding: "14px 6px", textAlign: "center" as const, fontSize: "9px", letterSpacing: "2px", textTransform: "uppercase" as const, color: "#7ab87a", borderBottom: "2px solid #7ab87a" },
    stepDone: { flex: 1, padding: "14px 6px", textAlign: "center" as const, fontSize: "9px", letterSpacing: "2px", textTransform: "uppercase" as const, color: "#3a5a38", borderBottom: "2px solid #3a5a38" },
    body: { padding: "32px 24px", maxWidth: "500px", margin: "0 auto" },
    eye: { fontSize: "9px", letterSpacing: "2.5px", textTransform: "uppercase" as const, color: "#4a7a48", marginBottom: "8px", fontWeight: 600 },
    title: { fontFamily: "Georgia,serif", fontSize: "30px", color: "#e8d5a3", marginBottom: "24px", fontWeight: 400, letterSpacing: "0.5px" },
    card: { background: "#060e06", border: "1px solid #1a2e1a", borderRadius: "18px", padding: "22px", marginBottom: "14px", boxShadow: "0 4px 30px #00000040" },
    cardTitle: { fontFamily: "Georgia,serif", fontSize: "16px", color: "#c8d8c0", marginBottom: "18px", paddingBottom: "12px", borderBottom: "1px solid #1a2e1a", fontWeight: 400 },
    g2: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginBottom: "14px" },
    lbl: { display: "block", fontSize: "9px", fontWeight: 600, letterSpacing: "2px", textTransform: "uppercase" as const, color: "#3a5a38", marginBottom: "7px" },
    inp: { width: "100%", boxSizing: "border-box" as const, padding: "12px 14px", background: "#0a1208", border: "1px solid #1a2e1a", borderRadius: "10px", fontSize: "13px", color: "#c8d8c0", fontFamily: "sans-serif", outline: "none" },
    sel: { width: "100%", padding: "12px 14px", background: "#0a1208", border: "1px solid #1a2e1a", borderRadius: "10px", fontSize: "13px", color: "#c8d8c0", fontFamily: "sans-serif", outline: "none", marginBottom: "14px" },
    err: { background: "#e6394612", border: "1px solid #e6394630", borderRadius: "12px", padding: "14px 16px", fontSize: "13px", color: "#e67a7a", marginBottom: "14px", lineHeight: 1.7 },
    ok: { background: "#27ae6012", border: "1px solid #27ae6030", borderRadius: "12px", padding: "11px 16px", marginBottom: "14px", fontSize: "12px", color: "#7ab87a" },
    info: { background: "#7ab87a0a", border: "1px solid #7ab87a20", borderRadius: "12px", padding: "12px 16px", marginBottom: "14px", fontSize: "12px", color: "#6a8a68", lineHeight: 1.7 },
    warn: { background: "#e8a21a10", border: "1px solid #e8a21a28", borderRadius: "12px", padding: "14px 16px", marginBottom: "14px" },
    warnTitle: { fontSize: "13px", fontWeight: 600, color: "#c8a040", marginBottom: "4px" },
    warnDesc: { fontSize: "12px", color: "#a08040", lineHeight: 1.6 },
    priceBox: { background: "#0a1208", border: "1px solid #1a2e1a", borderRadius: "12px", padding: "16px" },
    priceRow: { display: "flex", justifyContent: "space-between", fontSize: "13px", padding: "6px 0" },
    priceKey: { color: "#4a6a48" },
    priceVal: { color: "#c8d8c0", fontWeight: 500 },
    hr: { border: "none", borderTop: "1px solid #1a2e1a", margin: "10px 0" },
    totalRow: { display: "flex", justifyContent: "space-between", alignItems: "baseline", padding: "10px 0 0" },
    totalKey: { fontSize: "12px", color: "#6a8a68" },
    totalVal: { fontFamily: "Georgia,serif", fontSize: "32px", color: "#e8d5a3" },
    deposit: { display: "flex", justifyContent: "space-between", alignItems: "center", background: "#27ae6010", border: "1px solid #27ae6028", borderRadius: "12px", padding: "14px 16px", margin: "14px 0" },
    depKey: { fontSize: "12px", color: "#6aaa68" },
    depVal: { fontSize: "18px", fontWeight: 700, color: "#7ab87a", fontFamily: "Georgia,serif" },
    btn: { width: "100%", background: "#5aa858", color: "#050d05", border: "none", borderRadius: "12px", padding: "17px", fontSize: "14px", fontWeight: 700, cursor: "pointer", fontFamily: "sans-serif", letterSpacing: "0.5px" },
    btnDisabled: { width: "100%", background: "#1a2e1a", color: "#2a4a28", border: "none", borderRadius: "12px", padding: "17px", fontSize: "14px", fontWeight: 700, cursor: "not-allowed" as const, fontFamily: "sans-serif" },
    btnBack: { width: "100%", background: "transparent", color: "#4a6a48", border: "1px solid #1a2e1a", borderRadius: "12px", padding: "14px", fontSize: "13px", fontWeight: 500, cursor: "pointer", fontFamily: "sans-serif", marginTop: "10px" },
    resItem: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 0", borderBottom: "1px solid #111e11" },
    resKey: { fontSize: "13px", color: "#4a6a48" },
    resVal: { fontSize: "13px", color: "#c8d8c0", fontWeight: 500 },
    payOpt: { border: "1px solid #1a2e1a", borderRadius: "16px", padding: "18px", marginBottom: "12px", cursor: "pointer", background: "#060e06" },
    payOptSel: { border: "1px solid #4a9a48", borderRadius: "16px", padding: "18px", marginBottom: "12px", cursor: "pointer", background: "#4a9a4810" },
    payHead: { display: "flex", alignItems: "center", gap: "12px", marginBottom: "6px" },
    radio: { width: "18px", height: "18px", borderRadius: "50%", border: "2px solid #2a4a28", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center" },
    ...
    radioDot: { width: "8px", height: "8px", borderRadius: "50%", background: "#0a1208" },
    payTitle: { fontSize: "14px", fontWeight: 600, color: "#c8d8c0" },
    paySub: { fontSize: "11px", color: "#3a5a38" },
    payBody: { fontSize: "12px", color: "#6a8a68", lineHeight: 1.7, paddingLeft: "30px", marginTop: "8px" },
    successWrap: { textAlign: "center" as const, padding: "48px 24px" },
    successIco: { fontSize: "48px", marginBottom: "24px" },
    successTitle: { fontFamily: "Georgia,serif", fontSize: "32px", color: "#e8d5a3", marginBottom: "10px", fontWeight: 400 },
    successCode: { fontFamily: "Georgia,serif", fontSize: "24px", color: "#c8a840", background: "#c8a84010", border: "1px solid #c8a84030", borderRadius: "14px", padding: "16px 24px", margin: "20px 0", letterSpacing: "3px" },
    successDesc: { fontSize: "13px", color: "#6a8a68", lineHeight: 1.8, marginBottom: "24px" },
    bank: { background: "#060e06", border: "1px solid #1a2e1a", borderRadius: "16px", padding: "20px", textAlign: "left" as const },
    bankTitle: { fontSize: "9px", letterSpacing: "2px", textTransform: "uppercase" as const, color: "#3a5a38", marginBottom: "14px", fontWeight: 600 },
    bankRow: { display: "flex", justifyContent: "space-between", fontSize: "13px", padding: "8px 0", borderBottom: "1px solid #111e11" },
    bankKey: { color: "#4a6a48" },
    bankVal: { color: "#c8d8c0", fontWeight: 500 },
    cardCompact: { background: "#060e06", border: "1px solid #1a2e1a", borderRadius: "14px", padding: "16px 18px", marginBottom: "12px" },
    cardTitleCompact: { fontFamily: "Georgia,serif", fontSize: "14px", color: "#c8d8c0", marginBottom: "10px", paddingBottom: "8px", borderBottom: "1px solid #1a2e1a", fontWeight: 400 },
    resItemCompact: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "5px 0", borderBottom: "1px solid #111e11" },
    resKeyCompact: { fontSize: "12px", color: "#4a6a48" },
    resValCompact: { fontSize: "12px", color: "#c8d8c0", fontWeight: 500 },
    priceBoxCompact: { background: "#0a1208", border: "1px solid #1a2e1a", borderRadius: "10px", padding: "12px" },
    ...
    totalValCompact: { fontFamily: "Georgia,serif", fontSize: "26px", color: "#e8d5a3" },
    depositCompact: { display: "flex", justifyContent: "space-between", alignItems: "center", background: "#27ae6010", border: "1px solid #27ae6028", borderRadius: "10px", padding: "10px 14px", marginTop: "10px" },
    payLogos: { display: "flex", gap: "8px", flexWrap: "wrap" as const, paddingLeft: "30px", marginTop: "10px", marginBottom: "6px" },
    payLogo: { display: "inline-flex", alignItems: "center", justifyContent: "center", padding: "4px 10px", borderRadius: "6px", fontSize: "10px", fontWeight: 700, letterSpacing: "0.5px", border: "1px solid #1a2e1a", background: "#0a1208" },
  }
