...
function ReservarInner() {
  ...
  const s = {
    ...
    stepBase: { flex: 1, padding: "14px 6px", textAlign: "center", fontSize: "10px", letterSpacing: "1.5px", textTransform: "uppercase", color: "#2a3e28", borderBottom: "2px solid transparent" },
    stepActive: { flex: 1, padding: "14px 6px", textAlign: "center", fontSize: "10px", letterSpacing: "1.5px", textTransform: "uppercase", color: "#7ab87a", borderBottom: "2px solid #7ab87a" },
    stepDone: { flex: 1, padding: "14px 6px", textAlign: "center", fontSize: "10px", letterSpacing: "1.5px", textTransform: "uppercase", color: "#4a6e48", borderBottom: "2px solid #4a6e48" },
