...
const TK_CSS = [
  ...
  "@media(min-width:768px){.tk-cabins-grid{display:grid;grid-template-columns:1fr 1fr;gap:24px;align-items:start;}.tk-hero{height:clamp(420px,45vw,620px)!important;}.tk-hero-text{padding:0 80px 64px!important;}.tk-hero-h1{font-size:64px!important;max-width:700px!important;}.tk-section{padding-left:80px!important;padding-right:80px!important;}.tk-acts-grid{grid-template-columns:repeat(4,1fr)!important;}.tk-rules-grid{grid-template-columns:repeat(3,1fr)!important;}.tk-between{display:none;}.tk-nav-inner{padding:0 80px!important;}.tk-container{max-width:1400px!important;}.tk-card{transition:transform 0.2s ease,box-shadow 0.2s ease;}.tk-card:hover{transform:translateY(-3px);box-shadow:0 12px 40px rgba(0,0,0,0.5);}.tk-card .tk-card-body{padding:24px 28px 28px!important;}}",
  "@media(min-width:1024px){.tk-cabins-grid{grid-template-columns:1fr 1fr 1fr;gap:28px;}.tk-hero-h1{font-size:72px!important;}}",
  "@media(min-width:1280px){.tk-section{padding-left:100px!important;padding-right:100px!important;}.tk-nav-inner{padding:0 100px!important;}}",
].join(" ")
...
export default function TemplateClasico({ tenant, cabins }: { tenant: TenantData; cabins: Cabin[] }) {
    ...
    <div style={{ fontFamily: SANS, background: BG, minHeight: "100vh", color: TEXT }}>
      ...
      <div className="tk-hero" style={{ position: "relative", minHeight: "320px", height: "clamp(380px, 55vw, 620px)", maxHeight: "500px", overflow: "hidden", marginTop: "56px" }}>
        {allPhotos.length > 0 ? allPhotos.map((photo, i) => (
          <img key={i} src={photo} alt=""
            style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", objectFit: "cover", display: "block", filter: "brightness(0.32)", transform: "scale(1.0)", opacity: i === heroIdx ? 1 : 0, transition: "opacity 1.6s ease" }} />
        )) : (
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column" as const, alignItems: "center", justifyContent: "center", textAlign: "center" as const, padding: "0 24px", zIndex: 3 }}>
          ...
          <div style={{ background: "rgba(0,0,0,0.52)", backdropFilter: "blur(6px)", WebkitBackdropFilter: "blur(6px)", borderRadius: "24px", padding: "36px 48px", display: "flex", flexDirection: "column" as const, alignItems: "center", maxWidth: "760px", width: "90%" }}>
            ...
            <div className="tk-hero-h1" style={{ fontFamily: SERIF, fontSize: "clamp(32px,6vw,68px)", fontWeight: 300, color: TEXT, lineHeight: 1.05, marginBottom: "18px", maxWidth: "700px" }}>
              {tagline && tagline !== tenant.business_name ? tagline : "Desconéctate en medio de la naturaleza"}
            </div>
      ...
      {tenant.verified && (
        <div style={{ background: "linear-gradient(90deg,rgba(6,6,6,0) 0%,rgba(201,168,76,0.06) 30%,rgba(201,168,76,0.10) 50%,rgba(201,168,76,0.06) 70%,rgba(6,6,6,0) 100%)", borderTop: "1px solid rgba(201,168,76,0.12)", borderBottom: "1px solid rgba(201,168,76,0.12)", padding: "10px 24px", display: "flex", alignItems: "center", justifyContent: "center", gap: "16px" }}>
          <svg width="18" height="21" viewBox="0 0 28 33" fill="none"><path d="M14 1L26 6V16C26 23.5 20.5 29.5 14 31.5C7.5 29.5 2 23.5 2 16V6Z" fill="rgba(201,168,76,0.08)" stroke={GOLD} strokeWidth="1.2"/><path d="M9 16.5L12.5 20L19 13" stroke={GOLD} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>
