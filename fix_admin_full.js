...
fs.writeFileSync(path.join(adminDir, "page.tsx"), PAGE, "utf8")
console.log("Written: app/admin/page.tsx")

fs.writeFileSync(path.join(__dirname, "app", "components", "AdminDashboard.tsx"), DASHBOARD, "utf8")
console.log("Written: app/components/AdminDashboard.tsx")
